...
def generate_launch_description():
    ...
    rviz_full_config = os.path.join(os.path.join(get_package_share_directory("moveit2_tutorials"), 
    "config", "demo_rviz_config.rviz"))
    rviz_empty_config = os.path.join(os.path.join(get_package_share_directory("moveit2_tutorials"), 
    "config", "demo_rviz_config.rviz"))
